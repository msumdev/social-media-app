        ...
        <div class="modal-dialog modal-dialog-centered rounded-0">
            <div class="modal-content ">
                <div class="modal-header bg_blue">
                    <p class="text-white fs-4">Report Chat Message</p>
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="reason" class="form-label fs-5">
                            <strong>Reason for reporting this message?</strong>
                            <i
                    ...
                    <div class="mb-3">
                        <label for="reason" class="form-label fs-5">
                            ...
                            <i
                                ...
                                data-bs-placement="top"
                                data-bs-custom-class="custom-tooltip"
                                title="Provide more information about why you are reporting this message for example if you are reporting for harassment, provide the specific comments or messages that are harassing."
                            ></i>
                        </label>
                        <div class="row">
                            <div class="col-12">
                                <textarea
                                    ...
                                    rows="5"
                                    placeholder="Provide more information about why you are reporting this message"
                                ></textarea>
                            </div>
                        </div>
                    </div>
...
export default {
    ...
    methods: {
        ...
        submit() {
            axios.post(`/chat/room/${this.roomId}/report/${this.messageId}`, this.report).then(response => {
                this.toast.success(response.data.message);

                this.toggle(this.roomId, this.messageId)
            }).catch(error => {
